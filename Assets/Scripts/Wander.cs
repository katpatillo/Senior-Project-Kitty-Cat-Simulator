...
///This code modified from the following source: https://forum.unity.com/threads/making-npcs-wander-in-2d.524950/
...
public class Wander : MonoBehaviour
{
    ...
    internal Vector3[] moveDirections = new Vector3[] { Vector3.zero, Vector3.right, Vector3.left, Vector3.zero};
    ...
    void Start()
    {
        ...
        ChooseMoveDirection();
        animator.SetInteger("Speed", currentMoveDirection);
